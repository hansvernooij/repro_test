...
# loop to obtain the sample size per camp
...
table.result(workperiod.h., "Working hours")
table.result(in.extensive, "Management system")
table.result(cut(campsize, c(0, 9, 30, 50, 100)), "Sampple size")
table.result(region, "Region")
table.result(province, "Province")
#======================
